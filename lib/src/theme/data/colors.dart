...
class AppColorsData extends Equatable {
  ...
  factory AppColorsData.light() => AppColorsData(
        ...
        black: const Color(0xFFF4F0EA),
        black66: const Color(0xFFF4F0EA).withValues(alpha: 0.66),
        black33: const Color(0xFFF4F0EA).withValues(alpha: 0.33),
        black16: const Color(0xFFF4F0EA).withValues(alpha: 0.16),
        black8: const Color(0xFFF4F0EA).withValues(alpha: 0.08),
        grey: const Color(0xFFDCD7D1),
        grey66: const Color(0xFFCFCAC4).withValues(alpha: 0.66),
        grey33: const Color(0xFFCFCAC4).withValues(alpha: 0.33),
