...
class LabTypographyData extends Equatable {
  ...
  static const LabTypographyData normal = LabTypographyData(
    /// App Typography
    h1: TextStyle(
      fontFamily: 'Inter',
  ...
  // Pre-built static instance - created once, never recreated
  static const LabTypographyData small = LabTypographyData(
    /// App Typography
    h1: TextStyle(
      fontFamily: 'Inter',
      package: 'zaplab_design',
  ...
  // Pre-built static instance - created once, never recreated
  static const LabTypographyData large = LabTypographyData(
    /// App Typography
    h1: TextStyle(
      fontFamily: 'Inter',
      package: 'zaplab_design',
